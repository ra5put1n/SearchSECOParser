...
#include "JavaScriptAntlrImplementation.h"
#include "generated/JavaScriptLexer.h"
#include "generated/JavaScriptParser.h"
#include "JavaScriptParserListenerCustom.h"

std::vector<HashData> JavaScriptAntlrImplementation::parseData(std::string data, std::string filePath)
{
...
void JavaScriptAntlrImplementation::ClearCache()
{
